...
// https://guess.localhost/index.html
public class HttpServerEncrypted{
	...
	public static void startServer() throws IOException {
		System.setProperty("javax.net.ssl.keyStore", "assignment2Encrypted/keystore.jks");
		System.setProperty("javax.net.ssl.keyStorePassword", "changeit");
		SSLServerSocketFactory sf = (SSLServerSocketFactory) SSLServerSocketFactory.getDefault();

		SSLServerSocket ss = (SSLServerSocket) sf.createServerSocket(443, 15);
	...
	public static void createReply(SSLSocket s, Request request) throws IOException {
